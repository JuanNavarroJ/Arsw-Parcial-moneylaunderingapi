...
public class MoneyLaunderingController
{
    ...
    public List<SuspectAccount> getOffendingAccounts() {
        return moneyLaunderingService.getSuspectAccounts();
    }

    @RequestMapping(method = RequestMethod.POST) 
    public ResponseEntity<?> addOffendingAccount(@RequestBody SuspectAccount sa) {
    ...
    public ResponseEntity<?> modifyOffedingAccount(@PathVariable("accountId") String accountId, @RequestBody SuspectAccount sa) {
        moneyLaunderingService.updateAccountStatus(sa);
